...
package com.nhn.android.me2day.sample.multipart;
...
public class FilePart extends PartBase {
    ...
    private long sendingDataLength; 
    ...
    throws FileNotFoundException {
        this(name, new FilePartSource(filename, bytes), null, null);
    }
    ...
    protected void sendData(OutputStream out) throws IOException {
        //Log.d("FilePart", "enter sendData(OutputStream out)");
        if (lengthOfData() == 0) {
    ...
    protected PartSource getSource() {
        //Log.d("FilePart", "enter getSource()");
        return this.source;
    }
    ...
    protected long lengthOfData() {
        //Log.d("FilePart", "enter lengthOfData()");
